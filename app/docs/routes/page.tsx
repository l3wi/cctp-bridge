...
export default function RoutesPage() {
  return <DocsArticle title="Route guides" category="Route guides" description="Start with the network your USDC is on. Each guide covers the wallets, gas, and steps needed to reach your destination." sections={[
    ...
    { id: "other-networks", title: "Looking for another network?", content: <p>These guides cover a selection of routes. Browse <Link href="/usdc" className="text-docs-link underline">all supported USDC routes</Link> to open a bridge with your networks selected. Choose native USDC, check both gas balances, and review the quote before sending.</p> },
  ]} />;
}
